...
| [authority-oversight.md](./authority-oversight.md)                                 | Specified 2026-09-20; an authority role (ANAC) that reads the register of all riggers and each rigger's virtual log, read only                                                                                               |
| [authority-rig-register.md](./authority-rig-register.md)                           | Specified 2026-09-20; a country on every account, and the authority's list of every packed rig, filtered by where the owner lives                                                                                            |
