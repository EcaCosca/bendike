...
| [manual-library.md](./manual-library.md)                                           | Specified 2026-09-20; Library section for riggers and admins, manuals kept in Google Drive behind a storage port; needs Eca's one-time Drive authorisation                                |
| [packing-sheets.md](./packing-sheets.md)                                           | Specified 2026-09-20; guided pack job with the CIAC/ANAC checklist, missing-box notes, signing, print and a digital logbook; depends on manual-library                                    |
